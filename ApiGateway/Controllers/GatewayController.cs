...
namespace ApiGateway.Controllers
{
    ...
    public class GatewayController : ControllerBase
    {
        ...
        public GatewayController(IApiOrchestrator apiOrchestrator, ILogger<ApiGatewayLog> logger, IHttpService httpService, IApiClient apiClient)
        {
    ...
    public async Task<IActionResult> Delete(string serviceName, string page, string parameters =null)
    {
            ...
            var response = await _apiClient.DeleteAsync<object>(
            baseUrl: $"{apiInfo.BaseUrl}", pathWithQuery: $"{routeInfo.Path}");
